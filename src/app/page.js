...
<div className="about-us text-white py-16 px-8 md:px-16 lg:px-32">
      ...
      <div className="cta text-center mt-16">
        ...
        <p className="text-gray-300 leading-relaxed mb-8">
          At Smoz we believe that a watch is more than just a tool for telling time—it is a reflection of your personal style and a statement of who you are. We invite you to explore our collection and discover the perfect watch that speaks to you.
        </p>
